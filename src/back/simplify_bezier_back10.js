    ...
    if (Clen > 2) {
        ...
        if (isRightAngle) {
            ...
            if (pI) {
                ...
                let rx = +Math.min(r1, r2).toFixed(9);;
                let ry = +Math.max(r1, r2).toFixed(9);;
        ...
        console.log('even', even, Clen);


        
        // odd - take mid segment control points
        if (!even) {
        ...
        // even - calculate interpolated mid tangents
        else{
