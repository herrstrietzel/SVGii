(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.SVGii = global.SVGii || {}));
  ...
  function renderCommands(pathData, target = 'svg1') {
  ...
  function renderPoly(svg, pts, strokeWidth = "1%", stroke = "purple", render = true) {
  ...
  //!!! delete- rename
  function renderPerpendicularLine(pt, len = 10, angle) {
      let ptA = {
...
`;
  ...
  exports.adjustViewBox = adjustViewBox;
  exports.renderCommands = renderCommands;
  exports.renderPath = renderPath;
  exports.renderPerpendicularLine = renderPerpendicularLine;
  exports.renderPoint = renderPoint;
  exports.renderPoly = renderPoly;
